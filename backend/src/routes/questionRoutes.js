...
router.get('/subject-limit/:subject_id', authenticate, requireSubscription, ctrl.getSubjectDailyUsage);
router.get('/years', authenticate, ctrl.getAvailableYears);
router.post('/submit', authenticate, requireSubscription, ctrl.submitAnswers);
